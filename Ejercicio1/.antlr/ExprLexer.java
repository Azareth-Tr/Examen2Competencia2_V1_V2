...
public class ExprLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"PUBLIC", "STATIC", "VOID", "CLASS", "SYSTEM", "OUT", "PRINTLN", "BREAK", 
			"DEFAULT", "THIS", "RETURN", "FOR", "WHILE", "DO", "SWITCH", "STRING", 
			"INT", "DOUBLE", "CHAR", "IF", "ELSE", "ELSE_IF", "TEXTO", "IDT", "NUM", 
			"MAS", "MENOS", "POR", "ENTRE", "COMPLEMENTO", "AND", "OR", "NOT", "MAYOR", 
			"MAYOR_IGUAL", "MENOR", "MENOR_IGUAL", "ASIGNACION", "PAR_1", "PAR_2", 
			"COR_1", "COR_2", "LLA_1", "LLA_2", "PUNTO_COMA", "PUNTO", "WS"
		};
	}
